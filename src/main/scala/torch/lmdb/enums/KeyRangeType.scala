...
enum KeyRangeType:
   ...
   */
  case FORWARD_ALL extends KeyRangeType(true, false, false)
   ...
   */
  case FORWARD_AT_LEAST extends KeyRangeType(true, true, false)
   ...
   */
  case FORWARD_AT_MOST extends KeyRangeType(true, false, true)
   ...
   */
  case FORWARD_CLOSED extends KeyRangeType(true, true, true)
   ...
   */
  case FORWARD_CLOSED_OPEN extends KeyRangeType(true, true, true)
   ...
   */
  case FORWARD_GREATER_THAN extends KeyRangeType(true, true, false)
   ...
   */
  case FORWARD_LESS_THAN extends KeyRangeType(true, false, true)
   ...
   */
  case FORWARD_OPEN extends KeyRangeType(true, true, true)
   ...
   */
  case FORWARD_OPEN_CLOSED extends KeyRangeType(true, true, true)
   ...
   */
  case BACKWARD_ALL extends KeyRangeType(false, false, false)
   ...
   */
  case BACKWARD_AT_LEAST extends KeyRangeType(false, true, false)
   ...
   */
  case BACKWARD_AT_MOST extends KeyRangeType(false, false, true)
   ...
   * would be 8, 6 and 4.
   */
  case BACKWARD_CLOSED extends KeyRangeType(false, true, true)
   ...
   * 8, 6 and 4.
   */
  case BACKWARD_CLOSED_OPEN extends KeyRangeType(false, true, true)
   ...
   * keys would be 8, 6, 4 and 2.
   */
  case BACKWARD_GREATER_THAN extends KeyRangeType(false, false, true)
   ...
   */
  case BACKWARD_LESS_THAN extends KeyRangeType(false, true, false)
   ...
   * and 6.
   */
  case BACKWARD_OPEN extends KeyRangeType(true, true, true)
   ...
   * 8, 6 and 4.
   */
  case BACKWARD_OPEN_CLOSED extends KeyRangeType(true, true, true)

  private var directionForward = false
  private var startKeyRequired: Boolean = false
  private var stopKeyRequired: Boolean = false
