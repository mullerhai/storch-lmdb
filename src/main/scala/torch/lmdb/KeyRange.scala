...
import torch.lmdb.KeyRangeType.BACKWARD_ALL
import torch.lmdb.KeyRangeType.FORWARD_ALL
...
final class KeyRange[T](private val types: KeyRangeType, private val start: T, private val stop: T)
