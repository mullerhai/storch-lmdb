...
libraryDependencies += "com.github.jnr" % "jnr-constants" % "0.10.4"
...
libraryDependencies += "io.netty" % "netty-buffer" % "5.0.0.Alpha2"
// https://mvnrepository.com/artifact/junit/junit
libraryDependencies += "junit" % "junit" % "4.13.2" % Test
// https://mvnrepository.com/artifact/org.agrona/agrona
libraryDependencies += "org.agrona" % "agrona" % "2.2.2"
